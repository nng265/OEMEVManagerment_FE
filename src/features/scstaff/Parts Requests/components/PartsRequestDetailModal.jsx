...
//     if (isValid)
//       return <div className="validation-success">✅ File Valid! Proceed.</div>;
//     return (
...
//   // --- MAIN RENDER FOR DELIVERED STATUS ---
...
//                       ))
//                     ) : (
//                       <option disabled>No serials</option>
//                     )}
//                   </select>
//                 </div>
//                 <div className="form-group" style={{ flex: 3 }}>
...
//         {/* Nút Confirm Receipt hiện ở footer khi Delivered */}
