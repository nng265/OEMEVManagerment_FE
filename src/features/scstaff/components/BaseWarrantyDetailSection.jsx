    ...
    <>
      ...
      <DetailSection title="Customer Information">
        <div className="detail-grid">
          ...
          <div className="detail-item">
            ...
            <span className="value">{warrantyData?.customerPhoneNumber || "-"}</span>
          </div>
        </div>
      </DetailSection>
      ...
      {warrantyData?.attachments?.length > 0 && (
        <DetailSection title="Attachments">
          <div className="attachments-grid" style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
        ...
        <DetailSection title="Approved Warranty Record">
          <div className="detail-grid">
            <div className="detail-item">
              ...
              <span className="value" style={{ fontWeight: "600", color: "#2c5282" }}>
                {warrantyData.policyName}
              </span>
            </div>
          </div>
