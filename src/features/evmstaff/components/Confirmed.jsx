...
export function Comfirm({ request, onClose, onDelivered, isLoading }) {
  ...
  const handleDeliveredClick = () => {
    if (window.confirm("Mark this request as delivered?")) {
  ...
  return (
    ...
    <div className="popup-card">
      ...
      <div className="popup-body">
        ...
        <div className="info-row"><strong>Expected Date:</strong> {request.waitingDate || request.expectedDate}</div>
        ...
        <div className="popup-actions">
          ...
          <button className="btn-confirm" onClick={handleDeliveredClick} disabled={isLoading}>
